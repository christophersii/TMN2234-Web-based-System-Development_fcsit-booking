<?php
  ...
  if($_SERVER['REQUEST_METHOD'] == 'POST'){
      ...
      if (empty($username)){
          ...
          echo "<script>window.open('AdminUpdateInternal.php','_self')</script>";
          exit();
      }else{
      ...
      if (empty($_POST["password"])){
        ...
        echo "<script>window.open('InternalProfileUpdate.php','_self')</script>";
        exit();
      }else{
    ...
    if ($username == true && $Password = true && $ContactNo == true){
      ...
      if ($dbcon->connect_error){
        ...
        $update_id=$_GET['upd'];
        $stmt = $dbcon->prepare("UPDATE internaluser SET UserName=?, ContactNo=?, Password=? WHERE UserID='$update_id'");
...
<head>
    ...
    <title>Internal Profile Update Form</title>
