...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if (empty($username)){
        ...
        echo "<script>window.open('AdminAddInternal.php','_self')</script>";
        exit();
    }else{
        $username = true;
    }
    ...
    if ($username == true && $email == true && $Password == true && $cpassword == true && $ContactNo == true){
      ...
      if($count->num_rows == 0)
      {
          ...
          $stmt->execute();
          echo "<script>alert('Internal user added successfully!')</script>";
          echo "<script>window.open('AdminInternal.php','_self')</script>";
      }
      else{
...
<body>
    <div id="mySidenav" class="sidenav">
        ...
        <a href="AdminRoom.php" id="Room">Book <img class="sidebaricon" src="image/meeting-room.svg" alt="Dashboard" ></a>
        ...
        <div class="form_container">
          ...
          <div class="row clearfix">
            <form name="reg_form" id="reg_form" method="post";>
              ...
              <a class="button" type="submit" href="InternalLogin.php"><input type="submit" Value="Add"><a>
              <a class="button1" href="AdminInternal.php">Back</a>
            </form>
          </div>
        </div>
      </div>
