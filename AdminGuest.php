...
<head>
    ...
    <title>List of Guest User</title>
...
<body>
    ...
    <div class="form_wrapper2">
        <h3 class="indexH3">List of Guest User</h3>
            <a  href="AdminAddGuest.php?add"><button>Add</button></a>
            ...
            <table>
                <tr>
                    ...
                    $view_guests_query="select * from publicuser";//select query for viewing users.  
                    $run=mysqli_query($dbcon,$view_guests_query);//here run the sql query.  
                ...
                <tr>
                  ...
                  <td><a href="deleteguest.php?del=<?php echo $GuestID ?>"><button>Delete</button></a>
                  <a href="AdminUpdateGuest.php?upd=<?php echo $GuestID ?>"><button>Update</button></a></td>
                </tr>
                </tr> 
                <?php } ?> 
          </table>
      ...
      <div class="footer">
          <h4>Created by:<sup>G4_ </sup>SWEC_ <sub><a class= "subfooter" href="https://eleap.unimas.my/user/view.php?id=5547&course=1518" target="_blank">69860</a></sub> _ <sub><a class= "subfooter" href="https://eleap.unimas.my/user/profile.php?id=5567">69385</a></sub> _ <sub><a class= "subfooter" href="https://eleap.unimas.my/user/view.php?id=5548&course=1518" target="_blank">69847</a></sub> _ <sub><a class= "subfooter" href="https://eleap.unimas.my/user/profile.php?id=5567">71680</a> </sub></h4>
      </div>
    </div>
  </body>
</html>
