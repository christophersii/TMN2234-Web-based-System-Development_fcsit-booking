...
$stmt->execute();
$delete_query="delete from publicbookinginvoice WHERE BookingNo='$cancel_id'";
...
//javascript function to open in the same window   
    ...
    echo "<script>window.open('GuestDashboard.php?canceled=booking has been canceled','_self')</script>";  
}  
?> 